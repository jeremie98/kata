...
function getCurrentLocale(locale: SupportedLocale): Locale {
...
function Calendar({
  ...
  locale = getCurrentLocale(currentLocale as SupportedLocale);
  ...
  const MONTHS = React.useMemo(() => {
    ...
    return genMonths(
      locale as Pick<Locale, 'options' | 'localize' | 'formatLong'>
    );
  }, []);
...
>(
  (
    ...
    let loc = getCurrentLocale(currentLocale);
    const { options, localize, formatLong } = loc;
