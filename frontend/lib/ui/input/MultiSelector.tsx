...
export interface MultiSelectorRef<T> {
  selectedValue: T[];
...
const MultiSelector = React.forwardRef<
  MultiSelectorRef<unknown>,
  MultiSelectorProps<unknown>
>(
  (
    {
      value,
    ...
    ref: React.Ref<MultiSelectorRef<unknown>>
  ) => {
    ...
    return (
      ...
      >
        <div
          className={cn(
            'border-input ring-offset-background min-h-10 cursor-pointer rounded-md border text-sm',
            {
        ...
        >
          <div className="relative flex flex-wrap gap-1">
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'placeholder:text-muted-foreground flex-1 cursor-pointer bg-transparent outline-none',
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="bg-popover text-popover-foreground animate-in relative top-1 z-50 w-full rounded-md border shadow-md outline-none"
              onMouseLeave={() => {
